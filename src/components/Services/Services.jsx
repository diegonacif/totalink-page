        ...
        <section>
          ...
          <Fade left cascade duration={800}>
            ...
            <div className="service-wrapper">
              ...
              <p>A Total Ink dispõe de coleta e entrega de equipamentos e cartuchos e toners, além de serviços de manutenção corretiva e preventiva de impressoras. Aqui você encontra a solução completa com atendimento personalizado para pequenas, médias e grandes empresas.</p>
            </div>
          </Fade>
        </section>
      </Fade>
